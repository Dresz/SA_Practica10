...
const ipr = process.env.IPR || "127.0.0.1";
...
app.post('/pedido', function (req, res) {
    ...
    axios.post('http://'+ip+':8081/pedido', {
      combo: pedido
      })
      .then((res) => {
  ...
  axios.post('http://'+ipr+':8080/recibirpedido', {
  ...
  app.post('/estado', function (req, res) {
    axios.post('http://'+ip+':8081/estado', {
  ...
  app.post('/estado2', function (req, res) {
    axios.post('http://'+ipr+':8080/estado', {
      orden: req.body.orden
    })
    .then((res) => {
      //console.log(`statusCode: ${res.statusCode}`)
  ...
  app.post('/entregado', function (req, res) {
    axios.post('http://'+ipr+':8080/entregado', {
      orden: req.body.orden
    })
    .then((res) => {
      //console.log(`statusCode: ${res.statusCode}`)
